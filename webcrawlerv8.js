...
var xpath_price = getPathTo($this);
var length=xpath_price.length;
var i = 0;
var xpath_dis=0;
while(i<length){
...
{
	if($myimgs[i].width == width &&$myimgs[i].height > minheight && $myimgs[i].height<maxheight)
	samecount++;
	i++;
}
if (samecount >10)
...
{
  answers= get_price($($myimgs[myi]),flag);
