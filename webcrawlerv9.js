...
if($this.css('font-weight') == 'bold' && flag == true) weight-=3;
// Has strike through
...
while(i < max-1){
if(distances[i].text == text && flag == true) weight *= (max-i)+10;
if(distances[i].text == text && flag != true) weight *= (max-i);
i++;
}
