...
#from product list page find out price
weburl = "http://www.manufactum.com/outerwear-c193631/"
imgurl = "http://images.manufactum.de/manufactum/thumbs_188/40165_1.jpg"

#find out imgxpath by image url and web url
...
for status in sta:
    print status
# find out  the price xpath from list page by comparing xpath distance
